    ...
    prose: dict[str, dict[str, Any]] = {
        ...
        "cfs": {
            ...
            "description": (
                ...
                "atmosphere-ocean-land forecast, ensemble member 01, six-hourly from 6 to 6552 "
                "hours — thirty-nine weeks of a nine-month run. The surface fields are on the "
                "model's native T126 Gaussian grid (0.9375°) and the sea level pressure, "
                "pressure-level heights, temperatures, winds, vertical velocity and derived "
                "water vapour flux on the regular 1° grid NCEP publishes them on, so each "
                "bundle states the grid its own planes are on. Two cycles a day (00Z and 12Z); "
                "only the newest is kept. The precipitation rate, downward shortwave radiation "
                "and total cloud cover are means over the six hours ending at each frame."
            ),
            "license": "other",
            "providers": [_NOAA_PROVIDER, _XUE_PROVIDER],
            "links": [_NOAA_LICENSE_LINK],
        ...
        "himawari": {
            "title": "Himawari-9 AHI full disk",
            "description": (
                "The Japan Meteorological Agency's Himawari-9 Advanced Himawari Imager at 140.7°E, "
                "as NOAA redistributes it on its open data bucket (the ISatSS full-disk product): "
            ...
            "providers": [
                {
                    "name": "Japan Meteorological Agency",
                    "roles": ["producer", "licensor"],
                    "url": "https://www.data.jma.go.jp/mscweb/en/himawari89/",
                },
                {
