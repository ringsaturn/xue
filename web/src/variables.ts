...
function buildSpecs(): readonly VariableSpec[] {
  ...
  // Aerosols. Clean air is the map: every ramp starts at nothing and comes
  // in translucent, so they take the slate. The optical depths are one
  // family — the whole column heads it, the five species are its chips —
  // and read on one legend; the particulates are the other, each size cut
  // with a ceiling of its own. The `?type=` spellings take the id, plus
  // the ways the two headline fields are written.
  surface({
    id: "aod",
    chart: "aod",
    family: "aod",
    ...
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAod",
    ground: "slate",
    urlName: "aod",
    urlAliases: ["aod550", "aerosol", "aerosols", "opticaldepth"],
    meteogramCode: "AOD",
    showcaseCode: "AOD",
  }),
  surface({
    ...
    group: "aerosol",
    code: "AOD DUST",
    title: ["Dust", "Optical Depth"],
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAoddust",
    ground: "slate",
    urlName: "aoddust",
    urlAliases: ["dustaod"],
    showcaseCode: "AOD DUST",
  }),
  surface({
    id: "aodsalt",
    chart: "aodsalt",
    ...
    group: "aerosol",
    code: "AOD SALT",
    title: ["Sea Salt", "Optical Depth"],
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAodsalt",
    ground: "slate",
    urlName: "aodsalt",
    urlAliases: ["seasalt", "saltaod"],
    showcaseCode: "AOD SALT",
  }),
  surface({
    id: "aodsulf",
    chart: "aodsulf",
    ...
    group: "aerosol",
    code: "AOD SULF",
    title: ["Sulphate", "Optical Depth"],
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAodsulf",
    ground: "slate",
    urlName: "aodsulf",
    urlAliases: ["sulphate", "sulfate", "sulfateaod"],
    showcaseCode: "AOD SULF",
  }),
  surface({
    id: "aodorg",
    chart: "aodorg",
    ...
    group: "aerosol",
    code: "AOD ORG",
    title: ["Organic Carbon", "Optical Depth"],
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAodorg",
    ground: "slate",
    urlName: "aodorg",
    urlAliases: ["organic", "organiccarbon", "smoke"],
    showcaseCode: "AOD ORG",
  }),
  surface({
    id: "aodbc",
    chart: "aodbc",
    ...
    group: "aerosol",
    code: "AOD BC",
    title: ["Black Carbon", "Optical Depth"],
    bufferTitle: "Aerosol buffer",
    labelKey: "varLabelAodbc",
    ground: "slate",
    urlName: "aodbc",
    urlAliases: ["blackcarbon", "soot"],
    showcaseCode: "AOD BC",
  }),
  surface({
    id: "pm25",
    ...
    bufferTitle: "Particulate buffer",
    labelKey: "varLabelPm25",
    ground: "slate",
    urlName: "pm25",
    urlAliases: ["pm2p5", "particulate", "airquality"],
    meteogramCode: "PM2.5",
    showcaseCode: "PM2.5",
  }),
  surface({
  ...
  surface({
    ...
    bufferTitle: "Particulate buffer",
    labelKey: "varLabelPm10dust",
    ground: "slate",
    urlName: "pm10dust",
    urlAliases: ["dustpm10", "dustconcentration"],
    showcaseCode: "PM10 DUST",
  }),
