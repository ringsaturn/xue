"""Cut the GOES CMIPF fixture: twelve small windows of real full-disk files.
...
six channels the Dust RGB and DEBRA read (C07, C08, C11, C13, C14, C15) of
two consecutive GOES-19 scans — cut with ``gdal_translate -of netCDF -srcwin``, which keeps the
...
source directory the twelve files are downloaded from the public bucket
(anonymous, ~300 MB in all); with one, they are read from it. The cut
