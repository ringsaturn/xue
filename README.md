...
| Source | Grid and axis | Newest run |
|---|---|---|
| NOAA GFS 0.25° | 1440 × 721, 0.25°; hourly to F120, 3-hourly to F240 (161 frames) | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest.json&query=%24.run&label=run&color=0b7cbd&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest.json) |
| GFS surface flux | 3072 × 1536 Gaussian, ~13 km; as GFS | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-sflux.json&query=%24.run&label=run&color=2b6cb0&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-sflux.json) |
| ECMWF IFS open data 0.25° | 1440 × 721, 0.25°; 3-hourly to 144 h, 6-hourly to F240 (65 frames) | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ecmwf.json&query=%24.run&label=run&color=1f6f8b&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ecmwf.json) |
| ECMWF AIFS Single open data 0.25° | 1440 × 721, 0.25°; 6-hourly to F360 from every cycle (61 frames) | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-aifs.json&query=%24.run&label=run&color=3c7a89&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-aifs.json) |
| ECMWF IFS HRES via Open-Meteo | 3600 × 1801, 0.1°; hourly to F090, 3-hourly to F144, 6-hourly to F360 (145 frames), 00Z and 12Z only | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ifshres.json&query=%24.run&label=run&color=2a9d8f&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ifshres.json) |
| NOAA HRRR | 2441 × 1051, 0.03°, contiguous US; hourly to F18, a cycle every hour | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-hrrr.json&query=%24.run&label=run&color=7b4ea3&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-hrrr.json) |
| NOAA MRMS | 3500 × 1750, 0.02°, contiguous US; one frame every two minutes, a rolling four-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-mrms.json&query=%24.run&label=window&color=b7472a&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-mrms.json) |
| JMA precipitation nowcast | 5600 × 5000, 0.005°, Japan; one frame every five minutes, a rolling three-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-jma.json&query=%24.run&label=window&color=c25b2c&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-jma.json) |
| CMA radar mosaic | 1792 × 1024, 0.0439°, China; one frame every six minutes, a rolling three-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-cma.json&query=%24.run&label=window&color=b03a5b&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-cma.json) |
| Himawari-9 infrared, Dust RGB and DEBRA dust confidence | 3000 × 3000, 0.04°, the disk 80.7–200.7°E, ±60°; one scan every ten minutes, a rolling six-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-himawari.json&query=%24.run&label=window&color=6d597a&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-himawari.json) |
| GOES-19 (East) infrared, Dust RGB and DEBRA dust confidence | 3000 × 3000, 0.04°, the disk 135.2–15.2°W, ±60°; one scan every ten minutes, a rolling six-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeseast.json&query=%24.run&label=window&color=5c677d&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeseast.json) |
| GOES-18 (West) infrared, Dust RGB and DEBRA dust confidence | 3000 × 3000, 0.04°, the disk 163°E–77°W, ±60°; one scan every ten minutes, a rolling six-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeswest.json&query=%24.run&label=window&color=5c677d&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeswest.json) |
| Meteosat-12 infrared and Dust RGB | 3000 × 3000, 0.04°, the disk 60°W–60°E, ±60°; the scan on each hour (the cycle EUMETSAT releases openly), a rolling 24-hour window | [![the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-meteosat.json&query=%24.run&label=window&color=4a5d8f&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-meteosat.json) |
...
`--model` ids of the Usage section, which the badge links to): the cycle as `YYYYMMDDHH` UTC for a forecast, and for a
rolling window the hour it starts at, its frames running several hours
past it.
