...
- [![the newest gfs run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest.json&query=%24.runTime&label=&color=0b7cbd&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest.json) **NOAA GFS** — 0.25° global; hourly to F120, 3-hourly to F240
- [![the newest sflux run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-sflux.json&query=%24.runTime&label=&color=2b6cb0&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-sflux.json) **GFS surface flux** — ~13 km Gaussian global; as GFS
- [![the newest ecmwf run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ecmwf.json&query=%24.runTime&label=&color=1f6f8b&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ecmwf.json) **ECMWF IFS open data** — 0.25° global; 3-hourly to F144, 6-hourly to F240
- [![the newest aifs run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-aifs.json&query=%24.runTime&label=&color=3c7a89&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-aifs.json) **ECMWF AIFS Single** — 0.25° global; 6-hourly to F360
- [![the newest ifshres run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ifshres.json&query=%24.runTime&label=&color=2a9d8f&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ifshres.json) **ECMWF IFS HRES via Open-Meteo** — 0.1° global; hourly to F090, 3-hourly to F144, 6-hourly to F360, 00Z and 12Z
- [![the newest hrrr run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-hrrr.json&query=%24.runTime&label=&color=7b4ea3&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-hrrr.json) **NOAA HRRR** — 0.03° contiguous US; hourly to F18, a cycle every hour
- [![the newest mrms run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-mrms.json&query=%24.runTime&label=&color=b7472a&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-mrms.json) **NOAA MRMS radar** — 0.02° contiguous US; every 2 min, a rolling 4 h window
- [![the newest jma run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-jma.json&query=%24.runTime&label=&color=c25b2c&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-jma.json) **JMA precipitation nowcast** — 0.005° Japan; every 5 min, a rolling 3 h window
- [![the newest cma run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-cma.json&query=%24.runTime&label=&color=b03a5b&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-cma.json) **CMA radar mosaic** — 0.0439° China; every 6 min, a rolling 3 h window
- [![the newest himawari run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-himawari.json&query=%24.runTime&label=&color=6d597a&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-himawari.json) **Himawari-9 infrared, Dust RGB, DEBRA** — 0.04° disk at 140.7°E; every 10 min, a rolling 6 h window
- [![the newest goeseast run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeseast.json&query=%24.runTime&label=&color=5c677d&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeseast.json) **GOES-19 (East) infrared, Dust RGB, DEBRA** — 0.04° disk at 75.2°W; every 10 min, a rolling 6 h window
- [![the newest goeswest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeswest.json&query=%24.runTime&label=&color=5c677d&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeswest.json) **GOES-18 (West) infrared, Dust RGB, DEBRA** — 0.04° disk at 137°W; every 10 min, a rolling 6 h window
- [![the newest meteosat run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-meteosat.json&query=%24.runTime&label=&color=4a5d8f&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-meteosat.json) **Meteosat-12 infrared, Dust RGB** — 0.04° disk at 0°; hourly (the openly released cycle), a rolling 24 h window

Each badge reads the newest run off the source's live pointer
(`latest.json` for GFS, `latest-<model>.json` for the rest with the
`--model` ids of the Usage section, which it links to), in UTC: a
forecast's cycle, or the hour a rolling window starts at, its frames
running several hours past it. Grid sizes and frame counts are in the
source notes below.
