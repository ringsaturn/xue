...
| Source | `--model` | Grid | Axis | Pointer and newest run |
|---|---|---|---|---|
| NOAA GFS 0.25° | `gfs` | 1440 × 721, 0.25° | hourly to F120, 3-hourly to F240 (161 frames) | [![latest.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest.json&query=%24.run&label=latest.json&color=0b7cbd&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest.json) |
| GFS surface flux | `sflux` | 3072 × 1536 Gaussian, ~13 km | as GFS | [![latest-sflux.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-sflux.json&query=%24.run&label=latest-sflux.json&color=2b6cb0&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-sflux.json) |
| ECMWF IFS open data 0.25° | `ecmwf` | 1440 × 721, 0.25° | 3-hourly to 144 h, 6-hourly to F240 (65 frames) | [![latest-ecmwf.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ecmwf.json&query=%24.run&label=latest-ecmwf.json&color=1f6f8b&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ecmwf.json) |
| ECMWF AIFS Single open data 0.25° | `aifs` | 1440 × 721, 0.25° | 6-hourly to F360 from every cycle (61 frames) | [![latest-aifs.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-aifs.json&query=%24.run&label=latest-aifs.json&color=3c7a89&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-aifs.json) |
| ECMWF IFS HRES via Open-Meteo | `ifshres` | 3600 × 1801, 0.1° | hourly to F090, 3-hourly to F144, 6-hourly to F360 (145 frames), 00Z and 12Z only | [![latest-ifshres.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-ifshres.json&query=%24.run&label=latest-ifshres.json&color=2a9d8f&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-ifshres.json) |
| NOAA HRRR | `hrrr` | 2441 × 1051, 0.03°, contiguous US | hourly to F18, a cycle every hour | [![latest-hrrr.json: the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-hrrr.json&query=%24.run&label=latest-hrrr.json&color=7b4ea3&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-hrrr.json) |
| NOAA MRMS | `mrms` | 3500 × 1750, 0.02°, contiguous US | one frame every two minutes, a rolling four-hour window | [![latest-mrms.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-mrms.json&query=%24.run&label=latest-mrms.json&color=b7472a&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-mrms.json) |
| JMA precipitation nowcast | `jma` | 5600 × 5000, 0.005°, Japan | one frame every five minutes, a rolling three-hour window | [![latest-jma.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-jma.json&query=%24.run&label=latest-jma.json&color=c25b2c&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-jma.json) |
| CMA radar mosaic | `cma` | 1792 × 1024, 0.0439°, China | one frame every six minutes, a rolling three-hour window | [![latest-cma.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-cma.json&query=%24.run&label=latest-cma.json&color=b03a5b&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-cma.json) |
| Himawari-9 infrared, Dust RGB and DEBRA dust confidence | `himawari` | 3000 × 3000, 0.04°, the disk 80.7–200.7°E, ±60° | one scan every ten minutes, a rolling six-hour window | [![latest-himawari.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-himawari.json&query=%24.run&label=latest-himawari.json&color=6d597a&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-himawari.json) |
| GOES-19 (East) infrared, Dust RGB and DEBRA dust confidence | `goeseast` | 3000 × 3000, 0.04°, the disk 135.2–15.2°W, ±60° | one scan every ten minutes, a rolling six-hour window | [![latest-goeseast.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeseast.json&query=%24.run&label=latest-goeseast.json&color=5c677d&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeseast.json) |
| GOES-18 (West) infrared, Dust RGB and DEBRA dust confidence | `goeswest` | 3000 × 3000, 0.04°, the disk 163°E–77°W, ±60° | one scan every ten minutes, a rolling six-hour window | [![latest-goeswest.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-goeswest.json&query=%24.run&label=latest-goeswest.json&color=5c677d&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-goeswest.json) |
| Meteosat-12 infrared and Dust RGB | `meteosat` | 3000 × 3000, 0.04°, the disk 60°W–60°E, ±60° | the scan on each hour (the cycle EUMETSAT releases openly), a rolling 24-hour window | [![latest-meteosat.json: the newest window](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-meteosat.json&query=%24.run&label=latest-meteosat.json&color=4a5d8f&style=flat-square&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-meteosat.json) |

The last column is the source's live pointer, and the badge reads the
newest run off it (`YYYYMMDDHH`, UTC): a forecast's cycle, or the hour a
rolling window starts at, its frames running several hours past it.
