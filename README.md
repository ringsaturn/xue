...
| Source | `--model` | Grid | Axis | Pointer | Newest |
|---|---|---|---|---|---|
...
| GFS surface flux | `sflux` | 3072 × 1536 Gaussian, ~13 km | as GFS | `latest-sflux.json` | [![the newest run](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdataset.ringsaturn.me%2Fxue%2Flatest-sflux.json&query=%24.run&label=run&color=2b6cb0&style=for-the-badge&cacheSeconds=600)](https://dataset.ringsaturn.me/xue/latest-sflux.json) |
...
The last column reads the newest run off the live pointer (`YYYYMMDDHH`,
UTC): a forecast's cycle, or the hour a rolling window starts at, its
frames running several hours past it.
